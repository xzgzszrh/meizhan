...
async function updateData() {
  ...
  try {
    ...
    switch (error.response.status) {
      case 400:
        toast.warning('Error saving changes:', {
          description: 'The Date you have submitted is invalid. Please check your request'
        })
        break
      case 422:
        toast.warning('Error saving changes:', {
          description: 'You were NOT born then. Please check your request'
        })
        break
      default:
    ...
    <template #body>
      <div class="dialog-form-shell pb-4">
        <div class="dialog-form-group grid items-center gap-1.5 relative">
          <Label for="birthday" class="flex font-bold w-full justify-between"> Birthday </Label>
          <div>
